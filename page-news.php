        ...
        <div class="col-12 col-md-10">
          ...
          <hr>
           ...
           <nav class="menu-filter my-2  rounded text-uppercase">
            <ul class="d-flex flex-column flex-lg-row justify-content-around text-secondary  text-uppercase">
              
              <?php str_replace("title=\"View all posts filed under ","",
              wp_list_categories('use_desc_for_title=0&exclude=1,2,3,4,5,358,14&title_li=&hierarchical=1')); ?>
            </ul>
          </nav> 
          <hr>
...
$wp_query = new WP_Query($args); ?>
  ...
  <?php next_posts_link( '&larr; <button type="button" class="btn btn-secondary">Noticias anteriores</button>', $wp_query ->max_num_pages); ?>
  <?php previous_posts_link( 'Noticias recientes &rarr;' ); ?>
